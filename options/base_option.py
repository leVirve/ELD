...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--model", type=str, default="eld_model", help="chooses which model to use.", choices=model_names
        )
        self.parser.add_argument("--checkpoints_dir", type=str, default="./checkpoints", help="models are saved here")
        self.parser.add_argument("--resume", "-r", action="store_true", help="resume from checkpoint")
        self.parser.add_argument(
            "--resume_epoch", "-re", type=int, default=None, help="checkpoint to use. (default: latest"
        )
