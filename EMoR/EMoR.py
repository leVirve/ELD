...
def process_color_checker(datadir, name):
    ...
    img = (
        raw.postprocess(use_camera_wb=True, gamma=(1, 1), no_auto_bright=True, output_bps=16)[700:2500, 700:2000, :]
        / 65535.0
    )
    ...
    img = cv2.imread(imgpath, cv2.IMREAD_UNCHANGED)[700:2500, 700:2000, ::-1] / 255.0
